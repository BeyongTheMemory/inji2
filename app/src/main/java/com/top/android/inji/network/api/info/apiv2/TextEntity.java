...
import com.top.android.inji.ui.UriSpan;
...
public class TextEntity implements Parcelable {
    ...
    public com.top.android.inji.network.api.info.frodo.TextEntity toFrodo() {
        com.top.android.inji.network.api.info.frodo.TextEntity entity =
                new com.top.android.inji.network.api.info.frodo.TextEntity();
        entity.end = end;
        entity.start = start;
        entity.title = title;
        entity.uri = href;
    ...
    public static ArrayList<com.top.android.inji.network.api.info.frodo.TextEntity> toFrodo(
            ArrayList<TextEntity> entities) {
        ArrayList<com.top.android.inji.network.api.info.frodo.TextEntity> frodoEntities =
                new ArrayList<>();
