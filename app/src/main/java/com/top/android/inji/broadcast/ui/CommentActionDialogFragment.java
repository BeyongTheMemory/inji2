    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (mCanReplyTo && mCanDelete) {
            items = new CharSequence[] {
                    getString(com.top.android.inji.R.string.broadcast_comment_action_reply_to),
                    getString(com.top.android.inji.R.string.broadcast_comment_action_copy_text),
                    getString(com.top.android.inji.R.string.broadcast_comment_action_delete)
            };
        ...
        return new AlertDialog.Builder(getActivity(), getTheme())
                .setTitle(com.top.android.inji.R.string.broadcast_comment_action_title)
