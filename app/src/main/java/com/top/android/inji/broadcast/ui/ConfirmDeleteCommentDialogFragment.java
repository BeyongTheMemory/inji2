...
public class ConfirmDeleteCommentDialogFragment extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return new AlertDialog.Builder(getActivity(), getTheme())
                .setMessage(com.top.android.inji.R.string.broadcast_comment_delete_confirm)
                .setPositiveButton(com.top.android.inji.R.string.ok, (dialog, which) -> getListener().deleteComment(
                        mCommentId))
