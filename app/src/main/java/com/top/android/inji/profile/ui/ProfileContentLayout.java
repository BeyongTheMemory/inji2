...
import com.top.android.inji.ui.FlexibleSpaceContentLayout;
...
public class ProfileContentLayout extends FlexibleSpaceContentLayout {
    ...
    @BindDimen(com.top.android.inji.R.dimen.screen_edge_horizontal_margin)
    int mScreenEdgeHorizontalMargin;
    @BindDimen(com.top.android.inji.R.dimen.single_line_list_item_height)
    int mSingleLineListItemHeight;
    @BindDimen(com.top.android.inji.R.dimen.card_vertical_margin)
    int mCardVerticalMargin;
    @BindDimen(com.top.android.inji.R.dimen.card_shadow_vertical_margin)
    int mCardShadowVerticalMargin;
    @BindDimen(com.top.android.inji.R.dimen.horizontal_divider_height)
