...
import com.top.android.inji.network.api.info.frodo.BroadcastAttachment;
import com.top.android.inji.ui.CardIconButton;
import com.top.android.inji.ui.DividerItemDecoration;
import com.top.android.inji.ui.HorizontalImageAdapter;
import com.top.android.inji.ui.ImageLayout;
import com.top.android.inji.ui.OnHorizontalScrollListener;
import com.top.android.inji.ui.SizedImageItem;
...
public class BroadcastLayout extends LinearLayout {
    ...
    @BindView(com.top.android.inji.R.id.broadcastlayout_author_time_action_layout)
    ViewGroup mAuthorTimeActionLayout;
    @BindView(com.top.android.inji.R.id.broadcastlayout_avatar)
    ImageView mAvatarImage;
    @BindView(com.top.android.inji.R.id.broadcastlayout_name)
    TextView mNameText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_time)
    TimeTextView mTimeText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_action)
    TextView mActionText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_text)
    TextView mTextText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_rebroadcasted_attachment_images_layout)
    ViewGroup mRebroadcastedAttachmentImagesLayout;
    @BindView(com.top.android.inji.R.id.broadcastlayout_rebroadcasted_layout)
    ViewGroup mRebroadcastedLayout;
    @BindView(com.top.android.inji.R.id.broadcastlayout_rebroadcasted_name)
    TextView mRebroadcastedNameText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_rebroadcasted_action)
    TextView mRebroadcastedActionText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_rebroadcasted_text)
    TextView mRebroadcastedTextText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_rebroadcasted_broadcast_deleted)
    TextView mRebroadcastedBroadcastDeletedText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_attachment)
    RelativeLayout mAttachmentLayout;
    @BindView(com.top.android.inji.R.id.broadcastlayout_attachment_image)
    ImageView mAttachmentImage;
    @BindView(com.top.android.inji.R.id.broadcastlayout_attachment_title)
    TextView mAttachmentTitleText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_attachment_description)
    TextView mAttachmentDescriptionText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_single_image)
    ImageLayout mSingleImageLayout;
    @BindView(com.top.android.inji.R.id.broadcastlayout_image_list_layout)
    FrameLayout mImageListLayout;
    @BindView(com.top.android.inji.R.id.broadcastlayout_image_list_description_layout)
    FrameLayout mImageListDescriptionLayout;
    @BindView(com.top.android.inji.R.id.broadcastlayout_image_list_description)
    TextView mImageListDescriptionText;
    @BindView(com.top.android.inji.R.id.broadcastlayout_image_list)
    RecyclerView mImageList;
    @BindView(com.top.android.inji.R.id.broadcastlayout_rebroadcasted_attachment_images_space)
    Space mRebroadcastedAttachmentImagesSpace;
    @BindView(com.top.android.inji.R.id.broadcastlayout_actions)
    ViewGroup mActionsLayout;
    @BindView(com.top.android.inji.R.id.broadcastlayout_like)
    CardIconButton mLikeButton;
    @BindView(com.top.android.inji.R.id.broadcastlayout_comment)
    CardIconButton mCommentButton;
    @BindView(com.top.android.inji.R.id.broadcastlayout_rebroadcast)
    ...
    private void init() {
        ...
        ViewUtils.inflateInto(com.top.android.inji.R.layout.broadcast_layout, this);
    ...
    private void bindRebroadcastedAttachmentImages(Broadcast broadcast,
        ...
        if (hasImageList) {
            mImageListDescriptionText.setText(mImageListDescriptionText.getContext().getString(
                    com.top.android.inji.R.string.broadcast_image_list_count_format, images.size()));
