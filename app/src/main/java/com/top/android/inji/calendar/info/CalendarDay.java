...
package com.top.android.inji.calendar.info;
...
public class CalendarDay {
    ...
    public String getDateText(Context context) {
        ...
        String datePattern = context.getString(com.top.android.inji.R.string.calendar_date_pattern);
    ...
    public String getDayOfWeekText(Context context) {
        String[] dayOfWeekNames = context.getResources().getStringArray(
                com.top.android.inji.R.array.calendar_day_of_week_names);
        LocalDate date = getDate();
    ...
    public String getDayOfMonthText(Context context) {
        LocalDate date = getDate();
        return context.getString(com.top.android.inji.R.string.calendar_day_of_month_format, date.getDayOfMonth());
    }
    ...
    public int getDayOfMonthColor(Context context) {
        int weekdayColor = ContextCompat.getColor(context,
                com.top.android.inji.R.color.primary_text_default_material_light);
        int weekendColor = ContextCompat.getColor(context, com.top.android.inji.R.color.calendar_highlight_text);
        return getDayOfMonthColor(weekdayColor, weekendColor);
    }

    public String getTitleText(Context context) {
        return context.getString(com.top.android.inji.R.string.calendar_title_format, title);
    }
    ...
    public String getRatingText(Context context) {
        return context.getString(com.top.android.inji.R.string.calendar_rating_format, getRating());
    }

    public String getEventText(Context context) {
        return context.getString(com.top.android.inji.R.string.calendar_event_format, event);
    }
}
