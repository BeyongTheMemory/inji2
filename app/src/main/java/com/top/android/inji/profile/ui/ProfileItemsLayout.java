...
public abstract class ProfileItemsLayout extends FriendlyCardView {
    ...
    TextView mTitleText;
    @BindView(com.top.android.inji.R.id.item_list)
    ...
    @BindView(com.top.android.inji.R.id.secondary)
    TextView mSecondaryText;
    @BindView(com.top.android.inji.R.id.tertiary)
    ...
    private void init() {
        ...
        ViewUtils.inflateInto(com.top.android.inji.R.layout.profile_items_layout, this);
    ...
    protected void bind(UserItems primaryItems, UserItems secondaryItems, UserItems tertiaryItems) {
        ...
        mEmptyView.setText(context.getString(com.top.android.inji.R.string.profile_items_empty_format, stateString,
        ...
        if (secondaryItems != null && secondaryItems.total > 0) {
            mSecondaryText.setText(context.getString(com.top.android.inji.R.string.profile_items_non_primary_format,
        ...
        if (tertiaryItems != null && tertiaryItems.total > 0) {
            mTertiaryText.setText(context.getString(com.top.android.inji.R.string.profile_items_non_primary_format,
