...
public class BroadcastActivityDialogFragment extends AppCompatDialogFragment {
    ...
    @BindView(com.top.android.inji.R.id.tab)
    TabLayout mTabLayout;
    @BindView(com.top.android.inji.R.id.viewPager)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.top.android.inji.R.layout.broadcast_activity_dialog_fragment, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mPositiveButton.setText(com.top.android.inji.R.string.ok);
    ...
    private void updateTabTitle() {
        mTabAdapter.setPageTitle(mTabLayout, 0, getTabTitle(mBroadcast.likeCount,
                com.top.android.inji.R.string.broadcast_likers_title_format, com.top.android.inji.R.string.broadcast_likers_title_empty));
        mTabAdapter.setPageTitle(mTabLayout, 1, getTabTitle(mBroadcast.rebroadcastCount,
                com.top.android.inji.R.string.broadcast_rebroadcasted_broadcasts_title_format,
                com.top.android.inji.R.string.broadcast_rebroadcasted_broadcasts_title_empty));
    }
