...
import com.top.android.inji.ui.FlexibleSpaceLayout;
import com.top.android.inji.ui.IntProperty;
import com.top.android.inji.util.AppUtils;
import com.top.android.inji.util.ColorUtils;
...
public class ProfileLayout extends FlexibleSpaceLayout {
    ...
    @BindColor(com.top.android.inji.R.color.system_window_scrim)
    int mStatusBarColor;
    @BindColor(com.top.android.inji.R.color.dark_70_percent)
