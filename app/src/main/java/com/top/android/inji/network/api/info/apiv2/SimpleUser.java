...
public class SimpleUser implements UrlGettable, Parcelable {
    ...
    public static SimpleUser fromFrodo(
            com.top.android.inji.network.api.info.frodo.SimpleUser frodoSimpleUser) {
    ...
    @SuppressWarnings("deprecation")
    public com.top.android.inji.network.api.info.frodo.SimpleUser toFrodo() {
        com.top.android.inji.network.api.info.frodo.SimpleUser simpleUser =
                new com.top.android.inji.network.api.info.frodo.SimpleUser();
