...
public class BroadcastAdapter extends SimpleAdapter<Broadcast, BroadcastAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(ViewUtils.inflate(com.top.android.inji.R.layout.broadcast_item, parent));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.top.android.inji.R.id.rebroadcasted_by)
        public TextView rebroadcastedByText;
        @BindView(com.top.android.inji.R.id.card)
