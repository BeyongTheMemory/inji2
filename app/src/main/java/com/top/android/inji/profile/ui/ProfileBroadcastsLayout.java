...
public class ProfileBroadcastsLayout extends FriendlyCardView {
    ...
    TextView mTitleText;
    @BindView(com.top.android.inji.R.id.broadcast_list)
    ...
    private void init() {
        ViewUtils.inflateInto(com.top.android.inji.R.layout.profile_broadcasts_layout, this);
    ...
    public void bind(UserDTO user, List<Broadcast> broadcastList) {
        ...
        for (Broadcast broadcast : broadcastList) {
            ...
            if (i >= mBroadcastList.getChildCount()) {
                ViewUtils.inflateInto(com.top.android.inji.R.layout.profile_broadcast_item, mBroadcastList);
            }
