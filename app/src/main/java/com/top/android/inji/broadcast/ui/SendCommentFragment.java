...
public class SendCommentFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(com.top.android.inji.R.layout.broadcast_send_comment_fragment, container, false);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(com.top.android.inji.R.menu.broadcast_send_comment, menu);
        mSendCommentMenuItem = menu.findItem(com.top.android.inji.R.id.action_send_comment);
        updateSendCommentStatus();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                onFinish();
                return true;
            case com.top.android.inji.R.id.action_send_comment:
                onSendComment();
                return true;
            default:
    ...
    private void updateSendCommentStatus() {
        ...
        getActivity().setTitle(sendingComment ? com.top.android.inji.R.string.broadcast_send_comment_title_sending
                : com.top.android.inji.R.string.broadcast_send_comment_title);
